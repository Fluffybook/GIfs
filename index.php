...
<title>scripts</title>
<meta charset="utf-8">
<meta name="description" content="Scripts roblox">
...
<script data-cfasync="false" src='/clib/js/carousel.js?v=1'></script>
</head>
<body>
		...
		<div class="content-con-outside">
			<div class="content-con-inside">
				...
				<div class='landing-con-right content-remove '>
					<div class='landing-img-hero' style="background: url(https://i.imgur.com/7bBOA7u.gif) no-repeat center; background-size: contain;">
					</div>1
				</div>
			</div>
		</div>
